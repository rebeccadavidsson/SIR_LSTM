...
class HOPT():
    ...
    def simulate(self, ThreshConf=70):
        ...
        self.confModel = BasicRecurrentPredictor(
                    ...
                    rnnNoCells  = self.rnnNoCells, # no of RNN cells
        ...
        return {"pred": self.pred, "predDate": self.predDate, 
                "showTrainData": self.showTrainData, "showValData": self.showValData}
    ...
    def optimize(self):
        ...
        for i in range(2):
            ...
            print(f'Future steps: {futureSteps}')
            print(f'Type: {typ}')
            print(windowSize)
            ...
            self.FUTURE_DAYS  = futuresteps
            self.learning_rate = learning_rate
            self.futureSteps   = futureSteps
            self.rnnNoCells    = rnnNoCells
            self.simulate()
